...
const Footer = () => {
  return (
    <footer className="dark:bg-dark-2 border border-t bg-white">
      <div className="py-10">
            ...
            <div className="w-full px-4 md:w-1/2 lg:w-5/12 xl:w-4/12">
              <div>
                ...
                <div className="space-y-4">
                  <p className="flex font-medium leading-6 text-gray-600">
                    ...
                    <span> Shop 009A, Level 4, Block A</span>
                  </p>
                  <p className="flex items-center font-medium leading-6 text-gray-600">
                    <span className="pr-5">
                      <svg
                        width="24"
                        height="24"
